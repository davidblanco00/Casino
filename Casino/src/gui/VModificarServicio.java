...
public class VModificarServicio extends javax.swing.JDialog {
     ...
     */
    public VModificarServicio(java.awt.Frame parent, boolean modal, FachadaAplicacion fa, Servicios anterior) {
        super(parent, modal);
        initComponents();
        ...
        List<Zonas> trabaja=fa.zonasDisponible(anterior);
        modeloDisponible.setElementos(trabaja);
        List<Zonas> noTrabaja=fa.zonasNoDisponible(anterior);
        modeloNoDisponible.setElementos(noTrabaja);
    ...
    private void jButtonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAceptarActionPerformed
        // TODO add your handling code here:
        Servicios nuevo=new Servicios(anterior.getNombre(),jEditorPaneDescripcion.getText());
        fa.modificarServicio(nuevo,modeloDisponible.getElementos());
        this.dispose();
